...
#define PHASE_U_HS              &IfxEgtm_ATOM0_0_TOUT64_P20_8_OUT       /* Pin which will be driven by the PWM, P02.0 */
#define PHASE_U_LS              &IfxEgtm_ATOM0_0N_TOUT65_P20_9_OUT     /* Pin which will be driven by the PWM, P11.6 */
#define PHASE_V_HS              &IfxEgtm_ATOM0_1_TOUT66_P20_10_OUT       /* Pin which will be driven by the PWM, P02.2 */
#define PHASE_V_LS              &IfxEgtm_ATOM0_1N_TOUT67_P20_11_OUT      /* Pin which will be driven by the PWM, P02.4 */
#define PHASE_W_HS              &IfxEgtm_ATOM0_2_TOUT68_P20_12_OUT     /* Pin which will be driven by the PWM, P02.9 */
#define PHASE_W_LS              &IfxEgtm_ATOM0_2N_TOUT69_P20_13_OUT   /* Pin which will be driven by the PWM, P02.10*/
...
void initEgtmAtom3phInv(void)
{
    ...
    channelConfig[1].timerCh      = IfxEgtm_Pwm_SubModule_Ch_1;  /* Atom channel index to be used for sync channel   */
    ...
    channelConfig[1].dtm          = &dtmConfig[0];               /* Dead time configuration for this channel         */
    ...
    channelConfig[2].timerCh      = IfxEgtm_Pwm_SubModule_Ch_2;  /* Atom channel index to be used for sync channel   */
    ...
    channelConfig[2].dtm          = &dtmConfig[0];               /* Dead time configuration for this channel         */
    ...
    config.alignment              = IfxEgtm_Pwm_Alignment_center;      /* Alignment */
