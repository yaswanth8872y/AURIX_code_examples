...
#if defined(DEVICE_TC49X) || defined(DEVICE_TC4DX) || defined(DEVICE_TC49XN) || defined(DEVICE_TC4ZX)
...
#elif defined(DEVICE_TC45X) || defined(DEVICE_TC48X) || defined(DEVICE_TC44X) || defined(DEVICE_TC42X) ||\
