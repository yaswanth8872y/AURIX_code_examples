...
#elif (IFX_CFG_CLOCK_XTAL_FREQUENCY == (50000000))
#define IFXCLOCK_CFG_XTAL_FREQ        50MHZ
#else
#error "Wrong XTAL frequency configuration! check IFX_CFG_CLOCK_XTAL_FREQUENCY configuration in Ifx_Cfg.h."
#error "AurixPlus Triboard supported crystal frequencies are  10MHz, 20MHz, 25MHz 40MHz and 50MHz"
#endif
...
#error "Supported PLL frequencies are 80MHz, 100MHz, 133MHz (8MHz XTAL doesn't support), 160Mhz, 200MHz, 240MHz, 300MHz, 400MHz, 450MHz and 500MHz."
#endif
...
#if (IFX_CFG_CLOCK_PERPLL1_FREQUENCY == (160000000))
...
#error "Supported PLL1 frequency is 160MHz."
#endif
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 and k3 dividers have initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ_400MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(20 - 1), (IfxClock_K2divider)(8 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ_400MHZ */
#else
/* Ramp Osc is enabled hence k2 and k3 dividers have final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(20 - 1), (IfxClock_K2divider)(2 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_400MHZ_400MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 and k3 dividers have initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 450MHZ target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ_450MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(4 - 1), (IfxClock_Ndivider)(45 - 1), (IfxClock_K2divider)(3 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(1 - 1), (IfxClock_K3PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ_450MHZ */
#else
/* Ramp Osc is enabled hence k2 and k3 dividers have final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 450MHz target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ_450MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider }*/            \
    {(IfxClock_Pdivider)(4 - 1), (IfxClock_Ndivider)(45 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(1 - 1), (IfxClock_K3PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_450MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */


#ifndef IFXCLOCK_CFG_PLL_STEPS_40MHZ_400MHZ
/**** Macro for Pll step for profile with 40MHz Crystal and 400MHz target (fDCO= 800MHz)*/
#define IFXCLOCK_CFG_PLL_STEPS_40MHZ_400MHZ  IFXCLOCK_CFG_PLL_STEPS_FDCO_800MHZ_TO_TARGET_400MHZ
#endif /*#ifndef IFXCLOCK_CFG_PLL_STEPS_40MHZ_400MHZ */

#ifndef IFXCLOCK_CFG_PLL_STEPS_40MHZ_450MHZ
/**** Macro for Pll step for profile with 40MHz Crystal and 400MHz target (fDCO= 450MHz)*/
#define IFXCLOCK_CFG_PLL_STEPS_40MHZ_450MHZ  IFXCLOCK_CFG_PLL_STEPS_FDCO_450MHZ_TO_TARGET_450MHZ
#endif /*#ifndef IFXCLOCK_CFG_PLL_STEPS_40MHZ_450MHZ */

/************** Target = 500MHz *****************/

#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 and k3 dividers have initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 500MHz/450MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ_450MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(2 - 1), (IfxClock_Ndivider)(25 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(1 - 1), (IfxClock_K3PreDivider)(2 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ_450MHZ */
#else
/* Ramp Osc is enabled hence k2 and k3 dividers have final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 40MHz Crystal and 500MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ_450MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(2 - 1), (IfxClock_Ndivider)(25 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(1 - 1), (IfxClock_K3PreDivider)(2 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_40MHZ_500MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */


#ifndef IFXCLOCK_CFG_PLL_STEPS_40MHZ_500MHZ
/**** Macro for Pll step for profile with 40MHz Crystal and 500MHz target (fDCO= 500MHz)*/
#define IFXCLOCK_CFG_PLL_STEPS_40MHZ_500MHZ  IFXCLOCK_CFG_PLL_STEPS_FDCO_500MHZ_TO_TARGET_500MHZ
#endif /*#ifndef IFXCLOCK_CFG_PLL_STEPS_40MHZ_500MHZ */

/*******************************50MHz Oscillator Frequency******************************************/

/************** Target = 400MHz *****************/

#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 and k3 dividers have initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ_400MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(16 - 1), (IfxClock_K2divider)(8 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ_400MHZ */
#else
/* Ramp Osc is enabled hence k2 and k3 dividers have final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ_400MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 400MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ_400MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(16 - 1), (IfxClock_K2divider)(2 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_400MHZ_400MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */
...
#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 and k3 dividers have initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 450MHZ target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ_450MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(9 - 1), (IfxClock_K2divider)(3 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(1 - 1), (IfxClock_K3PreDivider)(1 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ_450MHZ */
#else
/* Ramp Osc is enabled hence k2 and k3 dividers have final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 450MHz target (fDCO= 450)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ_450MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider }*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(9 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(1 - 1), (IfxClock_K3PreDivider)(1 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_450MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */


#ifndef IFXCLOCK_CFG_PLL_STEPS_50MHZ_400MHZ
/**** Macro for Pll step for profile with 50MHz Crystal and 400MHz target (fDCO= 800MHz)*/
#define IFXCLOCK_CFG_PLL_STEPS_50MHZ_400MHZ  IFXCLOCK_CFG_PLL_STEPS_FDCO_800MHZ_TO_TARGET_400MHZ
#endif /*#ifndef IFXCLOCK_CFG_PLL_STEPS_50MHZ_400MHZ */

#ifndef IFXCLOCK_CFG_PLL_STEPS_50MHZ_450MHZ
/**** Macro for Pll step for profile with 50MHz Crystal and 400MHz target (fDCO= 450MHz)*/
#define IFXCLOCK_CFG_PLL_STEPS_50MHZ_450MHZ  IFXCLOCK_CFG_PLL_STEPS_FDCO_450MHZ_TO_TARGET_450MHZ
#endif /*#ifndef IFXCLOCK_CFG_PLL_STEPS_50MHZ_450MHZ */

/************** Target = 500MHz *****************/

#if defined(IFX_CLOCK_DISABLE_RAMPCON)
/* Ramp Osc is disabled hence k2 and k3 dividers have initial step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 500MHz/450MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ_450MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(10 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(1 - 1), (IfxClock_K3PreDivider)(2 - 1) }
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ_450MHZ */
#else
/* Ramp Osc is enabled hence k2 and k3 dividers have final step value */
#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ_450MHZ
/**** Macro for Initial Pll step, for profile with 50MHz Crystal and 500MHz target (fDCO= 500)*/
#define IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ_450MHZ                            \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2PreDivider, uint8 k3Initial, uint8 k3PreDivider}*/            \
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(10 - 1), (IfxClock_K2divider)(1 - 1), (IfxClock_K2PreDivider)(1 - 1), (IfxClock_K3divider)(1 - 1), (IfxClock_K3PreDivider)(2 - 1)}
#endif /*#ifndef IFXCLOCK_CFG_SYS_PLL_50MHZ_500MHZ_450MHZ */
#endif /*#ifdefined IFX_CLOCK_DISABLE_RAMPCON */


#ifndef IFXCLOCK_CFG_PLL_STEPS_50MHZ_500MHZ
/**** Macro for Pll step for profile with 50MHz Crystal and 500MHz target (fDCO= 500MHz)*/
#define IFXCLOCK_CFG_PLL_STEPS_50MHZ_500MHZ  IFXCLOCK_CFG_PLL_STEPS_FDCO_500MHZ_TO_TARGET_500MHZ
#endif /*#ifndef IFXCLOCK_CFG_PLL_STEPS_50MHZ_500MHZ */
...
/************** Fpll1 = 160MHz, Fpll2 = 200MHz, Fpll3 = 200MHz *****************/
...
#ifndef IFXCLOCK_CFG_PER_PLL_50MHZ_160MHZ_200MHZ_200MHZ
/** \brief Macro for Initial Pll step, for profile with 50MHz Crystal and 160/200MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_PER_PLL_50MHZ_160MHZ_200MHZ_200MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2Predivider, uint8 k3Divider, uint8 k3Predivider, uint8 k4Divider, uint8 k4Predivider}*/\
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(16 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)0, (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)10, (IfxClock_K4divider)(2 - 1),(IfxClock_K4PreDivider)1}
#endif /*#ifndef IFXCLOCK_CFG_PER_PLL_50MHZ_160MHZ_200MHZ */
...
#ifndef IFXCLOCK_CFG_PER_PLL_40MHZ_160MHZ_200MHZ_200MHZ
/** \brief Macro for Initial Pll step, for profile with 40MHz Crystal and 160/200MHz target (fDCO= 800)*/
#define IFXCLOCK_CFG_PER_PLL_40MHZ_160MHZ_200MHZ_200MHZ                           \
/*{ uint8 pDivider, uint8 nDivider, uint8 k2Initial, uint8 k2Predivider, uint8 k3Divider, uint8 k3Predivider, uint8 k4Divider, uint8 k4Predivider}*/\
    {(IfxClock_Pdivider)(1 - 1), (IfxClock_Ndivider)(20 - 1), (IfxClock_K2divider)(5 - 1), (IfxClock_K2PreDivider)0, (IfxClock_K3divider)(2 - 1), (IfxClock_K3PreDivider)10, (IfxClock_K4divider)(2 - 1),(IfxClock_K4PreDivider)1}
#endif /*#ifndef IFXCLOCK_CFG_PER_PLL_40MHZ_160MHZ_200MHZ */
...
/************** SYSCCUCON1 : MCANHDIV  (Output : fMCANH)**************/
/* Target = 200 MHz AND Source = Fsource0 */
...
/****************************************************** ********/
/************** SYSCCUCON0 : STMDIV  (Output : fSTM)**************/
/* Target = 450 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_STMDIV_450MHZ
#define IFXCLOCK_CFG_STMDIV_450MHZ             (1)
#endif /*#ifndef IFXCLOCK_CFG_STMDIV_450MHZ */

/************** SYSCCUCON1 : EGTMDIV  (Output : fEGTM)**************/
/* Target = 450 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_EGTMDIV_450MHZ
#define IFXCLOCK_CFG_EGTMDIV_450MHZ             (1)
#endif /*#ifndef IFXCLOCK_CFG_GTMDIV_450MHZ */

/************** SYSCCUCON0 : SRIDIV  (Output : fSRI)**************/
/* Target = 450 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_SRIDIV_450MHZ
#define IFXCLOCK_CFG_SRIDIV_450MHZ             (1)
#endif /*#ifndef IFXCLOCK_CFG_SRIDIV_450MHZ */

/************** SYSCCUCON0 : SPBDIV  (Output : fSPB)**************/
/* Target = 150 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_SPBDIV_450MHZ
#define IFXCLOCK_CFG_SPBDIV_450MHZ             (5)
#endif /*#ifndef IFXCLOCK_CFG_SPBDIV_450MHZ */

/************** SYSCCUCON0 : CPBDIV  (Output : fCPB)**************/
/* Target = 225 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_CPBDIV_450MHZ
#define IFXCLOCK_CFG_CPBDIV_450MHZ             (2)
#endif /*#ifndef IFXCLOCK_CFG_CPBDIV_400MHZ */

/************** SYSCCUCON0 : TPBDIV  (Output : fTPB)**************/
/* Target = 225 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_TPBDIV_450MHZ
#define IFXCLOCK_CFG_TPBDIV_450MHZ             (2)
#endif /*#ifndef IFXCLOCK_CFG_TPBDIV_450MHZ */

/************** SYSCCUCON0 : FSIDIV  (Output : fFSI)**************/
/* Target = 90 MHz AND Source = Fsri */
#ifndef IFXCLOCK_CFG_FSIDIV_450MHZ
#define IFXCLOCK_CFG_FSIDIV_450MHZ             (IFXCLOCK_CFG_SRIDIV_450MHZ * 5)
#endif /*#ifndef IFXCLOCK_CFG_FSIDIV_450MHZ */

/************** SYSCCUCON0 : FSI2DIV  (Output : fFSI2)**************/
/* Target = 450 MHz AND Source = Fsri */
#ifndef IFXCLOCK_CFG_FSI2DIV_450MHZ
#define IFXCLOCK_CFG_FSI2DIV_450MHZ             (IFXCLOCK_CFG_SRIDIV_450MHZ * 1)
#endif /*#ifndef IFXCLOCK_CFG_FSI2DIV_450MHZ */

/************** SYSCCUCON1 : XGETH0DIV  (Output : fXGETH0)**************/
/* Target = 225 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_XGETH0DIV_450MHZ
#define IFXCLOCK_CFG_XGETH0DIV_450MHZ             (2)
#endif /*#ifndef IFXCLOCK_CFG_XGETH0DIV_450MHZ */

/************** SYSCCUCON1 : XGETH1DIV  (Output : fXGETH1)**************/
/* Target = 225 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_XGETH1DIV_450MHZ
#define IFXCLOCK_CFG_XGETH1DIV_450MHZ             (2)
#endif /*#ifndef IFXCLOCK_CFG_XGETH1DIV_450MHZ */

/************** SYSCCUCON1 : LETHDIV  (Output : fLETH)**************/
/* Target = 225 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_LETHDIV_450MHZ
#define IFXCLOCK_CFG_LETHDIV_450MHZ             (2)
#endif /*#ifndef IFXCLOCK_CFG_LETHDIV_400MHZ */

/************** SYSCCUCON1 : CANXLHDIV  (Output : fCANXLH)**************/
/* Target = 225 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_CANXLHDIV_450MHZ
#define IFXCLOCK_CFG_CANXLHDIV_450MHZ             (2)
#endif /*#ifndef IFXCLOCK_CFG_CANXLHDIV_450MHZ */

/************** SYSCCUCON1 : MCANHDIV  (Output : fMCANH)**************/
/* Target = 225 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_MCANHDIV_450MHZ
#define IFXCLOCK_CFG_MCANHDIV_450MHZ             (2)
#endif /*#ifndef IFXCLOCK_CFG_MCANHDIV_450MHZ */

/************** SYSCCUCON0 : SRICSDIV  (Output : fSRI)**************/
/* Target = 450 MHz AND Source = Fsource0 */
#ifndef IFXCLOCK_CFG_SRICSDIV_450MHZ
#define IFXCLOCK_CFG_SRICSDIV_450MHZ             (1)
#endif /*#ifndef IFXCLOCK_CFG_SRICSDIV_450MHZ */
...
/* Target = 200 MHz AND Source = Fsource3 */
